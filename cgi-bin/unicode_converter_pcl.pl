...
if( $ENV{'CONTENT_LENGTH'} > 0 ){                              #If input has been entered
    ...
    while( $x = chop( $decodedstr ) ){                         #Take one character at a time off the end of the string
        ...
        if( ord($x) <= 255 ){
            ...
            $codes_hex_mixed = "\\u" . dec_to_hex( ord($x) ) . $codes_hex_mixed;
        } 
...
<html lang="en">
    ...
    <body>
        ...
        <p class="center">This tool will convert special characters (such as CJK characters, special IPA characters,
        ...
        <hr>
        <a name="results">
        <form method="post" action="http://people.ku.edu/~sjpa/cgi-bin/unicode_converter_pcl.pl#results">
...
print <<HTMLfooter;
        ...
        <p class="mini">If this tool is not working, try <a href=
                                 ...
                                 identical tool</a> by Mark Swofford of PinyinInfo
                                 <span style="float:right"><a href="/~sjpa/chinesetools.html">back to 
                                 Chinese tools</a></span></p>
        <p class="mini">Script by <a href="/~sjpa">Stephen Politzer-Ahles</a>. Last modified on 2009-11-18.
        ...
        <dl class="mini">Version history:
            <dd>2009-10-25: Created (at http://people.ku.edu/~sjpa/unicode_converter.html)</dd>
            <dd>2009-10-27: Embedded script, moved to http://people.ku.edu/~sjpa/cgi-bin/unicode_converter.pl</dd>
            <dd><a href="/~sjpa/unicode_converter_code_20091118.txt">2009-11-18</a>: Added hex functionality</dd>
        </dl>-->
