...
<html lang="en">
    ...
    <body>
        ...
        <hr>
        <form method="post" action="http://people.ku.edu/~sjpa/cgi-bin/uyghurscript_dev.pl">
...
print <<HTMLfooter;
    <br style="clear:both"/>
        ...
        <dl class="mini">Version history:
            ...
            <dd><a href="/~sjpa/uyghurscript_code_20091215.txt">2009-12-15</a>: Replaced &#x00E9; with &#x00EB;.</dd>
        </dl>
...
sub convert_lat_ug{
	...
	while( $decodedstr ){				 	 	#Actual conversion
		...
		$decodedstr =~ s/^(&#x00F6;|&#x00D6;|&#x00FC;|&#x00DC;|&#x00EB;|&#x00CB;|&#x00E9;|&#x00C9;|&#x003F;|zh|gh|sh|ch|ng|[hy'sutjloxrnimzfqbgadekvwp .,;!?"\-])//i;
...
sub convert_lat_pin{
	...
	while( $decodedstr ){				 	 	#Actual conversion
		$lastdecodedstr = $decodedstr;				#Catch bigraphs and fancies in this regex
		$decodedstr =~ s/^(&#x00F6;|&#x00D6;|&#x00FC;|&#x00DC;|&#x00EB;|&#x00CB;|&#x00E9;|&#x00C9;|&#x003F;|zh|gh|sh|ch|ng|[hy'sutjloxrnimzfqbgadekvpw .,;!?"-])//i;
		if ($decodedstr eq $lastdecodedstr){ $newstr = "Aborting.\n"; last; }	#Error handler
...
sub convert_lat_cyr{
	...
	while( $decodedstr ){				 	 	#Actual conversion
		$lastdecodedstr = $decodedstr;				#Catch bigraphs and fancies in this regex
		$decodedstr =~ s/^(&#x00F6;|&#x00D6;|&#x00FC;|&#x00DC;|&#x00EB;|&#x00CB;|&#x00E9;|&#x00C9;|&#x003F;|zh|gh|sh|ch|ng|yu|ya|[hy'sutjloxrnimzfqbgadekvpw .,;!?"-])//i;
		if ($decodedstr eq $lastdecodedstr){ $newstr = "Aborting .\n"; last; }	#Error handler
		$letter = $1;	 						#Harvest the letter
