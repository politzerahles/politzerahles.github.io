...
<html lang="en">
    ...
    <body>
        ...
        <form method="post" action="http://www.nyu.edu/cgi-bin/cgiwrap/spa268/test.pl">
           <p class="center"><b><u>This is just a boring site that takes a text string as input, and then spits it back out below. Type or paste a string of characters into the box and click submit.</u></b></p>
