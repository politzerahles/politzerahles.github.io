...
<html lang="en">
    ...
    <body>
        ...
        <form method="post" action="http://www.mypolyuweb.hk/~sjpolit/homophones.pl">
...
print <<HTMLfooter;
	...
	<p class="centercol">Also note that this tool does not take individual characters'/pronunciations' token frequencies into account. For some psycholinguistic applications,
        ...
        <p class="mini">Script by <a href="http://users.ox.ac.uk/~cpgl0080/index.html">Stephen Politzer-Ahles</a>. Last modified on <a href=
                        "/projects/politzer-ahles/codearchive/homophones_code20091203.txt">2009-12-03</a> If you experience an error, contact
